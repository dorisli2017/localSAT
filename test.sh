timeout 5m /usr/bin/time -f "wtime=%e" ./lt $1 1962042455 &> $1.l1rt
timeout 5m /usr/bin/time -f "wtime=%e" ./lt $1 1112841915 &> $1.l2rt
timeout 5m /usr/bin/time -f "wtime=%e" ./lt $1 566263966 &> $1.l3rt
